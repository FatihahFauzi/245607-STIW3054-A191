...
public class GettingData {
    ...
    public void ReadData() throws IOException {
        ...
        for(Element tablenum:trs){
            ...
            Pattern pattern = Pattern.compile("Name: (.*?)<br>|Name :(.*?)<br>|:\\s(U.*)<br>|Name:(.*?)<br>|name :( .*?)<br> |Name (.*?)<br>"); // to create a pattern from the regular expression passed as parameter to method.
            ...
            url=tablenum.getElementsByTag("a").attr("abs:href");//how to find students github link


            Pattern pattern1 = Pattern.compile("(\\b2.*?)<br>");
            ...
            result.add(new Data(name,matric,url));//data student name,matric and githublink inside arraylist
        }
